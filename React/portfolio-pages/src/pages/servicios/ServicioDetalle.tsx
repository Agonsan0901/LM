...
export const ServicioDetalle = () => {
  ...
  const servicio = dataServicios.find((serv) => serv.id === Number(id)) as IServicio | undefined;

  if (!servicio) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] text-center p-6">
        <h2 className="text-2xl font-bold text-red-400 mb-2">Servicio no encontrado</h2>
        <p className="text-gray-400 mb-4">El servicio con ID {id} no existe o fue eliminado.</p>
